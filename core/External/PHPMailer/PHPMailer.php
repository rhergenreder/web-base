...
class PHPMailer
{
    ...
    public function getMailMIME()
    {
        ...
        switch ($this->message_type) {
            ...
            case 'alt_inline':
                ...
                break;
          case 'encrypted':
                $result .= $this->headerLine('Content-Type', static::CONTENT_TYPE_MULTIPART_ENCRYPTED . ';');
    ...
    public function createBody()
    {
        ...
        switch ($this->message_type) {
            ...
            case 'encrypted':
                $body .= $mimepre;
                $body .= $this->attachAll('', $this->boundary[1]);
                break;
            case 'attach':
                $body .= $mimepre;
                $body .= $this->getBoundary($this->boundary[1], $bodyCharSet, '', $bodyEncoding);
    ...
    protected function setMessageType()
    {
        ...
        if ($this->ContentType == self::CONTENT_TYPE_MULTIPART_ENCRYPTED) {
          $type[] = "encrypted";
        }
